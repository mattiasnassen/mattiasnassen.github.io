(function () {
  ...
  function gameState (state) {
    ...
    if (state === 'won') {
      modalMessage.innerHTML = '<h2>You cracked the code!</h2> <p>Congratulations, you can open the geocache with code 8611</p> <button class="large" id="hideModal">OK</button> <button id="restartGame" class="large primary">Restart</button>';
